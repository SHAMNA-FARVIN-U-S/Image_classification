...
image_dir=r"C:\Users\shamn\Desktop\IMAGE CLASSIFICATION\Dataset_Celebrities\cropped"
...
history=model.fit(x_train,y_train_one_hot,epochs=50,batch_size =32,validation_split=0.3)
...
image_paths_to_predict = [
     r'Dataset_Celebrities/cropped/serena_williams/serena_williams2.png'
